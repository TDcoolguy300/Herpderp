Arctic Observatory 13 - 24 February 2012

Website: http://nanotrasen.com
Code: http://code.google.com/p/arctic-observatory-13/
IRC: irc://irc.rizon.net/arcticobservatory13
...
Open arctic.dme by double-clicking it, open the Build menu, and click
compile.  This'll take a little while, and if everything's done right you'll get
a message like this:

saving arctic.dmb (DEBUG mode)

arctic.dmb - 0 errors, 0 warnings
...
compiled arctic.dmb file.  Make sure to set the port to the one you 
